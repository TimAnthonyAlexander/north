...
export const editBeforeAnchorTool: ToolDefinition<EditBeforeAnchorInput, EditPrepareResult> = {
    name: "edit_before_anchor",
    description:
    ...
    inputSchema: {
        ...
        properties: {
            ...
            anchor: {
                type: "string",
                description: "Text to find in a line. Content will be inserted before this line.",
            },
            content: {
                type: "string",
                description: "Content to insert before the anchor line",
            },
            occurrence: {
                type: "number",
                description:
