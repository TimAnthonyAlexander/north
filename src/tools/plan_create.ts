    ...
    inputSchema: {
        ...
        properties: {
            planText: {
                type: "string",
                description:
                    "The detailed plan text describing what changes will be made, why, and in what order. Be specific about files, functions, and implementation steps.",
            },
        },
        required: ["planText"],
    },
